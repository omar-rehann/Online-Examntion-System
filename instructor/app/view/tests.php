    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <hr>
                <a href="?assign&test=<?php echo $test->id ?>" id="assignButton" data-questions="<?php echo $test->fixedQuestions ?>" type="button" class="btn btn-outline-success btn-block mb-1"><i class="fa fa-plus"></i> Assign</a>
            </div>
            <br>
            <?php if (!$readOnly) { ?>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="app/controller/test.inc.php?editTest" id="edittestform" method="post">
                    ...
                    <tbody>
                        ...
                        foreach ($allTests as $test) { ?>
                            <tr>
                                ...
                                <td><span class="badge badge-success"><?php echo $test->fixedQuestions ?></span></td>
