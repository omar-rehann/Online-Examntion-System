                ...
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($review as $question) { ?>
                            <tr>
                                <td><i class="fa fa-user"></i> <?php echo $question->StudentName ?></td>
                                <td><?php echo $question->question ?></td>
                                <td><?php echo $question->textAnswer ?></td>
                                <td>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo (($percent < 50) ? ('<span class="badge badge-danger">' . $percent . '%') : ('<span class="badge badge-success">' . $percent . '%')) ?></td>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" onclick="window.print();" class="btn btn-outline-primary float-right mb-1 no-print"><i class="fa fa-print"></i> Print</button>
                </div>
                <div class="card">
                    <div class="card-body" id="resultDetails">
                        ...
                        <label class="control-label mb-1">
                            ...
                            <div class="col-6">
                                ...
                                <label class="control-label mb-1"><?php echo $result->ipaddr ?></label>
                            </div>
                            <div class="col-6">
                                <label class="control-label mb-1"><strong>Host Name: </strong></label>
                                <label class="control-label mb-1"><?php echo $result->hostname ?></label>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <label class="control-label mb-1"><strong>Grade<small> (Percent)</small>: </strong></label>
                            ...
                            <div class="card mb-4 shadow-sm no-print">
                                ...
                                <div class="card-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex justify-content-between align-items-center p-3 bg-<?php echo ($result->passPercent < $precent) ? 'success' : 'danger'; ?> text-white rounded">
                                                <span class="font-weight-bold"><i class="fas fa-percentage mr-2"></i>Grade (Percent):</span>
                                                <span class="badge badge-<?php echo ($result->passPercent < $precent) ? 'success' : 'danger'; ?> badge-pill py-2 px-3"><?php echo round($precent); ?>%</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex justify-content-between align-items-center p-3 bg-<?php echo ($result->passPercent < $precent) ? 'success' : 'danger'; ?> text-white rounded">
                                                <span class="font-weight-bold"><i class="fas fa-star mr-2"></i>Grade (Points):</span>
                                                <span class="badge badge-<?php echo ($result->passPercent < $precent) ? 'success' : 'danger'; ?> badge-pill py-2 px-3"><?php echo $result->FinalGrade . ' / ' . $result->TestDegree; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="card m-4">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <span class="float-right ml-3 badge badge-secondary"><?php echo $types[$answer->type] ?></span>
